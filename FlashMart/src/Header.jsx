...
const Header = () => {
    ...
    return (
        <header className="w-full bg-black text-white">
            {/* Top Line */}
            <div className="w-full flex justify-between items-center px-8 py-3 text-base border-b border-yellow-700 font-sans" style={{ fontFamily: 'Inter, Arial, sans-serif', letterSpacing: '0.03em', fontWeight: 500 }}>
                <p className="tracking-wide text-gray-200" style={{ fontSize: '1.05rem', lineHeight: '2.2rem' }}>
                ...
                <div className="flex items-center space-x-6">
                    ...
                    <a href="#" className="hover:text-yellow-500 transition-colors duration-200 font-semibold" style={{ fontSize: '0.75rem', lineHeight: '2.2rem' }}>Installment Plans</a>
                    <span className="text-gray-400">|</span>
                    <a href="#" className="flex items-center gap-2 hover:text-yellow-500 transition-colors duration-200 font-semibold" style={{ fontSize: '0.75rem', lineHeight: '2.2rem' }}>
